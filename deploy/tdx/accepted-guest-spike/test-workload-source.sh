...
git -C "$repository_root" archive 314b80ac1be55f0fb763587427f817d96c6803a1 | tar -xf - -C "$fixture/repository"
git -C "$repository_root" show 314b80ac1be55f0fb763587427f817d96c6803a1:Cargo.lock > "$fixture/repository/Cargo.lock"
