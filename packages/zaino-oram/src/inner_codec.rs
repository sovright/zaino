...
mod tests {
    ...
    fn request_round_trip_has_exact_shape_and_golden_digest() -> Result<(), InnerCodecError> {
        ...
        assert_eq!(
            digest(&envelope),
            [
                92, 4, 163, 21, 121, 220, 210, 44, 227, 70, 38, 252, 198, 46, 8, 251, 158, 83, 90,
                111, 73, 125, 235, 6, 51, 173, 14, 58, 143, 212, 75, 113,
            ]
        );
        Ok(())
    }
    ...
    fn response_round_trip_has_exact_shape_and_golden_digest() -> Result<(), InnerCodecError> {
        ...
        assert_eq!(
            digest(&envelope),
            [
                139, 237, 247, 243, 95, 241, 105, 18, 70, 243, 53, 217, 64, 209, 108, 76, 234, 56,
                88, 160, 223, 84, 84, 70, 105, 178, 166, 96, 54, 68, 163, 84,
            ]
        );
        Ok(())
    }
