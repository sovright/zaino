...
mod tests {
    ...
    fn request_round_trip_has_exact_shape_and_golden_digest() -> Result<(), InnerCodecError> {
        ...
        assert_eq!(
            digest(&envelope),
            [
                97, 130, 124, 214, 140, 248, 218, 255, 214, 245, 45, 151, 226, 115, 188, 180, 255,
                35, 108, 135, 207, 219, 240, 248, 54, 13, 91, 9, 17, 153, 19, 225,
            ]
        );
        Ok(())
    }
    ...
    fn response_round_trip_has_exact_shape_and_golden_digest() -> Result<(), InnerCodecError> {
        ...
        assert_eq!(
            digest(&envelope),
            [
                120, 25, 160, 47, 96, 9, 193, 37, 191, 249, 205, 188, 84, 230, 41, 118, 100, 9,
                120, 35, 17, 60, 65, 44, 12, 214, 85, 200, 169, 154, 10, 216,
            ]
        );
        Ok(())
    }
