...
pub const MAX_RAW_QUOTE_BYTES: usize = 16 * 1024;
...
pub struct ConfigFsTsmQuoteProvider {
    root: PathBuf,
}
...
impl Default for ConfigFsTsmQuoteProvider {
    fn default() -> Self {
        Self::new()
    }
}
...
impl ConfigFsTsmQuoteProvider {
    ...
    ) -> Result<Vec<u8>, ConfigFsQuoteError> {
        #[cfg(target_os = "linux")]
        {
